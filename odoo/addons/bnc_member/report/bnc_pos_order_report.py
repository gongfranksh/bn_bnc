...
class PosOrderReport(models.Model):
    _name = "bnc.report.pos.order"
    _description = "bnc member sale report"
    _auto = False
    _order = 'date desc'
    ...
    @api.model_cr
    def init(self):
        tools.drop_view_if_exists(self._cr, 'bnc_report_pos_order')
        self._cr.execute("""
            CREATE OR REPLACE VIEW bnc_report_pos_order AS (
                SELECT
                    MIN(l.id) AS id,
                    COUNT(*) AS nbr_lines,
